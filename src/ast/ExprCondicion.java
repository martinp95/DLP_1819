...
public class ExprCondicion extends AbstractExpr {

	public ExprCondicion(Expr left, String operador, Expr right) {
		this.left = left;
	...
	public ExprCondicion(Object left, Object operador, Object right) {
